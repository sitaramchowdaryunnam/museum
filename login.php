[15:35, 2/10/2020] Japan Sita Ram: <?php include('server.php') ?>
<!DOCTYPE html>
<html>
<head>
...
<body>
	...
	<form method="post" action="login.php">
        ...
        <input type="Username"style="margin:40px;width:70%;font-family: 'Play', sans-serif" class="form-control" name="username" placeholder="Enter Username" required>   
